...
var _default = {
  ...
  methods: {
    ...
    formRegister: function formRegister() {
      var _this = this;
      ...
      (0, _axios.default)({
        ...
        _this.emailRegister = "", _this.passwordRegister = "";
      });
    }
  }
};
    ...
    [
      _c(
        "div",
        {
          ...
          staticStyle: { width: "500px", "background-color": "#e5e5e5" }
        },
        [
          _c(
            "nav",
            { staticStyle: { "margin-left": "46px", "padding-top": "20px" } },
            [
              _c(
                "a",
                {
          ...
          _c(
            "div",
            { staticStyle: { padding: "0px 50px 50px 50px", margin: "0" } },
            [
              _c("h5", [_vm._v("Register Form")]),
              _vm._v(" "),
              _c(
                "form",
                {
                  on: {
                    submit: function($event) {
                      ...
                      return _vm.formRegister($event)
                    }
                  }
                },
                [
                  _c("div", { staticClass: "form-group" }, [
                    _c("label", { attrs: { for: "emailRegister" } }, [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "form-group" }, [
                    _c("label", { attrs: { for: "passwordRegister" } }, [
                      _vm._v("Password")
                    ]),
                    _vm._v(" "),
                    _c("input", {
                      ...
                      staticClass: "form-control",
                      attrs: { type: "password", id: "passwordRegister" },
...
var _default = {
  ...
  data: function data() {
    return {
      ...
      statusRegisterLogin: false,
      params: {
        client_id: "603798192515-glvgho7s38d1a6jakuh0558rve9kgj17.apps.googleusercontent.com"
      },
  ...
  methods: {
    ...
    formLogin: function formLogin() {
      ...
      (0, _axios.default)({
        ...
        console.log(result, "ini result"); // this.isLoggedIn = true;
        // this.getTask();
        ...
        swal(err.response.data.message, "", "error"); // swal(err.response, "", "error");
      }).finally(function () {
        _this.emailLogin = "", _this.passwordLogin = "";
      });
    },
    onSuccess: function onSuccess(googleUser) {
      ...
      console.log(id_token, "ini id token"); // console.log(profile);
      ...
      (0, _axios.default)({
        ...
        swal(err.response.data.message[0], "", "error");
      }).finally(function () {}); // This only gets the user information: id, name, imageUrl and email
    ...
    [
      _c(
        ...
        [
          ...
          _c("hr"),
          _vm._v(" "),
          _c("div", { staticStyle: { padding: "0px 50px 50px 50px" } }, [
...
},{"_css_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/CardContent.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    deleteTask: function deleteTask(params) {
      ...
      (0, _axios.default)({
        ...
        _this.$emit("requestDelete", "success");
    ...
    updateTask: function updateTask(params) {
      ...
      (0, _axios.default)({
        ...
        _this2.checkUpdateTask = true;
        console.log(result.data);
        _this2.valueEditTask = result.data[1][0].title;
      }).catch(function (err) {
        swal("Forbidden Access!", "", "error");
        console.log(err.response, "ini error update");
      });
    },
    moveTask: function moveTask(id, title, category) {
      var _this3 = this;

      var list = ["Backlog", "Todo", "Done", "Completed", "Backlog"];
      var newCategory;
      ...
      (0, _axios.default)({
        ...
        _this3.$emit("requestMove", "success");
    ...
    saveEditTask: function saveEditTask(params) {
      var _this4 = this;
      ...
      (0, _axios.default)({
        ...
        _this4.checkUpdateTask = false;

        _this4.$emit("requestUpdate", "success");
...
exports.default = _default;
        var $c00fad = exports.default || module.exports;
      
      if (typeof $c00fad === 'function') {
        $c00fad = $c00fad.options;
      }
    
        /* template */
        Object.assign($c00fad, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    !_vm.checkUpdateTask
      ? _c(
          ...
          [
            _c("p", { staticStyle: { "font-size": "20px", margin: "1" } }, [
              _vm._v(_vm._s(_vm.listTask.title))
            ]),
            _vm._v(" "),
            _c(
              "p",
            ...
            _c("p", { staticStyle: { margin: "0" } }, [
                ...
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.deleteTask(_vm.listTask.id)
                    }
                  }
                },
                [_vm._v("\n        Delete\n      ")]
              ...
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.updateTask(_vm.listTask.id)
                    }
                  }
                },
                [_vm._v("\n        Update\n      ")]
    ...
    _vm.checkUpdateTask
      ? _c(
          "div",
          {
            staticStyle: { "background-color": "bisque", "margin-top": "10px" }
          },
          [
            _c("div", { staticStyle: { "margin-left": "15px" } }, [
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.valueEditTask,
                    expression: "valueEditTask"
                  }
                ],
                staticStyle: { "background-color": "white", width: "270px" },
                domProps: { value: _vm.valueEditTask },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.valueEditTask = $event.target.value
                  }
                }
              }),
              _vm._v(" "),
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.saveEditTask(_vm.listTask.id)
                    }
                  }
                },
                [_vm._v("\n        Save\n      ")]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c00fad', $c00fad);
          } else {
            api.reload('$c00fad', $c00fad);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/CardCategory.vue":[function(require,module,exports) {
"use strict";
...
var _CardContent = _interopRequireDefault(require("./CardContent.vue"));
...
var _default = {
  ...
  components: {
    CardCategory: _CardContent.default
  }
};
exports.default = _default;
...
var _default = {
  ...
  methods: {
    statusLogin: function statusLogin(params) {
    ...
    requestLogout: function requestLogout(params) {
      this.isLoggedIn = params;
    },
    requestDelete: function requestDelete(params) {
      this.getTask();
...
exports.default = _default;
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "layout", attrs: { id: "layout" } }, [
    !_vm.isLoggedIn
      ? _c(
          "div",
          ...
          [
            _vm.viewStatus
              ? _c("Register", { on: { status: _vm.status } })
              : _vm._e(),
            _vm._v(" "),
            !_vm.viewStatus
              ? _c("Login", {
                  on: { statusLogin: _vm.statusLogin, status: _vm.status }
                })
              : _vm._e()
          ],
          1
...
},{"axios":"node_modules/axios/index.js","./components/Register":"src/components/Register.vue","./components/Login":"src/components/Login.vue","./components/NavbarAfterLogin":"src/components/NavbarAfterLogin.vue","./components/CardKanban.vue":"src/components/CardKanban.vue","_css_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
